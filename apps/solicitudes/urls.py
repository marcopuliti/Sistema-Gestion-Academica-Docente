...
urlpatterns = [
    ...
    path('<int:pk>/duplicar/', views.duplicar_solicitud, name='duplicar'),
    ...
    path('<int:pk>/acta-comision-carrera/', views.subir_acta_comision_carrera, name='subir_acta_comision_carrera'),
